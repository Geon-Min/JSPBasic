...
<body>
	...
	<form action = "req_get_parameter.jsp">
         ...
         <!-- radio는 name으로 통일시켜줘야, 여러새의 버튼을 하나의 그룹으로 보고 다중선택이 가능 합니다.    -->            
                        전공:
         <input type="radio" name="major" value = "경영학">경영학
         <input type="radio" name="major" value = "컴퓨터">컴퓨터
         <input type="radio" name="major" value = "전기차">전기전자
       ...
       <br/>
       <!--submit는 from안에 있는 데이터를 서버로 전송  -->
       <input type="submit" value="가입하기">
       <input type="button" value="그냥버튼"> <!--버튼에 기능을 직접 넣음  -->
